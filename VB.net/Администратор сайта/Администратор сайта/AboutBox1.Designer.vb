...
Partial Class AboutBox1
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBoxDescription.Text = "Описание:" & _
            ...
            "(Во время выполнения текст подписи будет заменен информацией о сборке приложения." & _
            Global.Microsoft.VisualBasic.ChrW(13) & Global.Microsoft.VisualBasic.ChrW(10) & _
            "Настроить эту информацию можно в области "Приложение" конструктора проектов.)"
        '
        'OKButton
        '
