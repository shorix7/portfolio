    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            If MBox = DialogResult.Yes Then
                ...
                OtchetGurnal = "Вмешательство в ключевое поле Акты " & DateString & " " & TimeString : ZapGurnal()
            End If
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Me.Text = "Добавление записи" Then
            ...
            Else
                ...
                Me.Close()
                OtchetGurnal = "Передача данных на выполнение добавления Акты " & DateString & " " & TimeString : ZapGurnal()
            End If
        Else
            p1 = TextBox1.Text
            p2 = TextBox2.Value
            ...
            Form15.Editor_zap()
            Me.Close()
            OtchetGurnal = "Передача данных на выполнение редактирования Акты " & DateString & " " & TimeString : ZapGurnal()
        End If
    End Sub
End Class