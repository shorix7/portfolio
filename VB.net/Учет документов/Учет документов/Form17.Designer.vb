...
Partial Class Form17
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolStripComboBox1.Items.AddRange(New Object() {"Регистрационный номер", "Дата регистрации", "Краткое содержание", "Количество листов", "Исполнитель", "Рассылка", "Отметка о помещении в дело"})
