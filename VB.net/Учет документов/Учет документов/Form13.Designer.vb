...
Partial Class Form13
    ...
    Private Sub InitializeComponent()
        ...
        Me.ToolStripComboBox1.Items.AddRange(New Object() {"Регистрационный номер", "Дата регистрации", "Краткое содержание", "Исполнитель", "Кому передан документ на исполнение", "Отметка о помещении в дело"})
        ...
        Me.MenuStrip1.Location = New System.Drawing.Point(319, 1)
        ...
        Me.МенюИсходящихToolStripMenuItem.Size = New System.Drawing.Size(239, 20)
