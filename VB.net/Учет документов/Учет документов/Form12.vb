Public Class Form12
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        If Me.Text = "Добавление записи" Then
            ...
            Else
                ...
                p6 = TextBox6.Text
                p7 = TextBox7.Text
                Form11.Dobavlenie_zap()
                Me.Close()
                OtchetGurnal = "Добавление записи в книгу Приказы по АХД " & DateString & " " & TimeString : ZapGurnal()
            End If
        Else
            p1 = TextBox1.Text
            p2 = TextBox2.Value
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        OtchetGurnal = "Отменена операция с Приказы по АХД " & DateString & " " & TimeString : ZapGurnal()
        Close()
    End Sub
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        ...
        Try
            ...
            If MBox = DialogResult.Yes Then
                ...
                OtchetGurnal = "Вмешательство в ключевое поле Приказов по АХД " & DateString & " " & TimeString : ZapGurnal()
            End If
